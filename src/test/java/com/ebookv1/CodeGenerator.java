...
// 2、全局配置
        ...
        gc.setOutputDir("D:\\study\\ebookV1"+ "/src/main/java");
        gc.setAuthor("17");
...
// 3、数据源配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/ebook?serverTimezone=GMT%2B8");
...
// 5、策略配置
        ...
        strategy.setInclude("subject","user");
